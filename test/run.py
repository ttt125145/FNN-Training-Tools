...
def update_progress_bars():
    ...
    while completed_futures_count < num_total_batches:
        try:
            update_info = progress_bar_queue.get(timeout=1)  # 设置超时，避免无限等待
            ...
            if xuhao_batch in batch_progress_bars:
                ...
                if batch_progress_bars[xuhao_batch].n >= total_iterations_per_batch:
...
if __name__ == "__main__":
    ...
    # 定义要并行运行的 xuhao 批次
    xuhao_batches_to_run = [x for x in range(0, 10)]
